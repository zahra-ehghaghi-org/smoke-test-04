...
GitHub repository (this repo)
   ...
   ├─ charts/smoke-test-04/    Helm chart (Deployment, Service,
...
This service is deployed to the `dev` namespace and reachable
at:

```
http://smoke-test-04-dev.test.com
```
...
3. CD updates `charts/smoke-test-04/values-dev.yaml`
...
gh run list --workflow=smoke-test-04-cicd.yaml
```
...
```bash
kubectl logs -n dev -l app.kubernetes.io/instance=smoke-test-04 --tail=100
```
